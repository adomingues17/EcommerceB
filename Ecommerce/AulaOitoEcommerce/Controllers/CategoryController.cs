using AulaOitoEcommerce.Data;
using AulaOitoEcommerce.Models;
using Microsoft.AspNetCore.Mvc;

namespace AulaOitoEcommerce.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public IActionResult Index(string busca, int pagina = 1, int tamanhoDaPagina = 5)
        {
